...
public class OverrideFieldNameTestCase {
	...
	public void testSimpleFieldMap() {
		ClassMap<Address, AddressDTO> classMap = ClassMapBuilder.map(Address.class, AddressDTO.class)
				.field("country", "countryName")
				.field("city", "cityName")
				.toClassMap();
		MapperFactory factory = new DefaultMapperFactory(new HashSet<ClassMap<?, ?>>(Arrays.asList(classMap)), null, null);
